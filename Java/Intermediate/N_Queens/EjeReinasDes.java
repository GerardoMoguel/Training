 ...
 * @author rgamboah
 */
public class EjeReinasDes implements InterfazReinas
{
    ...
    public static void main(String[] args)
    {
       ...
       InterfazReinas  objServ = null;
        try {
            objServ = (InterfazReinas) Class.forName("ejereinasdes.EjeReinasDes").newInstance();
            //objServ.setIMPRIME(false);
             deltaT_perm_mSeg = objServ.ejecuta(N);
            System.out.println(N + "," + "Permutaciones" + "," + deltaT_perm_mSeg); 
        } catch (Exception ex) {
            Logger.getLogger(EjeReinasDes.class.getName()).log(Level.SEVERE, null, ex);
        }
